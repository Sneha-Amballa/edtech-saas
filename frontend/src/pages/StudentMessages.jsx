...
const StudentMessages = () => {
  ...
  useEffect(() => {
    if (chats.length > 0) {
      let allIndividualChats = [];
      chats.forEach(group => {
        group.chats.forEach(chat => {
          allIndividualChats.push({
            ...chat,
      ...
      let filtered = allIndividualChats;
              ...
              filteredChats.map((chat) => (
                ...
                >
                  <div className="chat-item-avatar">
                    ...
                    {chat.mentor.isActive && <div className="user-status"></div>}
                  </div>
                  <div className="chat-item-content">
                    <div className="chat-item-top">
                      <div className="chat-item-name">{chat.mentor.name}</div>
        ...
        <div className="chat-main">
          {selectedChatId ? (
            ...
            <div className="chat-empty-state">
              ...
              <div className="chat-empty-subtext">Choose a chat from the left to start messaging</div>
            </div>
          )}
        </div>
      </div>
